...
ASSETS_LIST = [
    ...
    {"asset_code": "RAKUTEN-VTI", "proxy_ticker": "VTI", "name": "楽天・全米株式インデックス・ファンド", "asset_class": "Stock", "default_ret": 0.07, "default_vol": 0.16},
    {"asset_code": "EMAXIS-SEN-ST", "proxy_ticker": "VEA", "name": "eMAXIS Slim 先進国株式インデックス", "asset_class": "Stock", "default_ret": 0.06, "default_vol": 0.16},
    {"asset_code": "NISSEI-GAI-ST", "proxy_ticker": "VEA", "name": "ニッセイ外国株式インデックスファンド", "asset_class": "Stock", "default_ret": 0.06, "default_vol": 0.16},
    {"asset_code": "EMAXIS-JAP", "proxy_ticker": "EWJ", "name": "eMAXIS Slim 国内株式(TOPIX)", "asset_class": "Stock", "default_ret": 0.05, "default_vol": 0.17},
    {"asset_code": "EMAXIS-NIK", "proxy_ticker": "EWJ", "name": "eMAXIS Slim 国内株式(日経平均)", "asset_class": "Stock", "default_ret": 0.05, "default_vol": 0.17},
    {"asset_code": "NISSEI-NIK", "proxy_ticker": "EWJ", "name": "ニッセイ日経225インデックスファンド", "asset_class": "Stock", "default_ret": 0.05, "default_vol": 0.17},
    {"asset_code": "HIFUMI-PLUS", "proxy_ticker": "EWJ", "name": "ひふみプラス", "asset_class": "Stock", "default_ret": 0.05, "default_vol": 0.17},
    {"asset_code": "EMAXIS-JAP-BND", "proxy_ticker": "IGOV", "name": "eMAXIS Slim 国内債券インデックス", "asset_class": "Bond", "default_ret": 0.01, "default_vol": 0.03},
    {"asset_code": "NISSEI-JAP-BND", "proxy_ticker": "IGOV", "name": "ニッセイ国内債券インデックスファンド", "asset_class": "Bond", "default_ret": 0.01, "default_vol": 0.03},
    {"asset_code": "EMAXIS-SEN-BND", "proxy_ticker": "BNDX", "name": "eMAXIS Slim 先進国債券インデックス", "asset_class": "Bond", "default_ret": 0.02, "default_vol": 0.06},
    {"asset_code": "EMAXIS-JAP-REIT", "proxy_ticker": "VNQ", "name": "eMAXIS Slim 国内リートインデックス", "asset_class": "REIT", "default_ret": 0.04, "default_vol": 0.15},
    {"asset_code": "EMAXIS-SEN-REIT", "proxy_ticker": "VNQ", "name": "eMAXIS Slim 先進国リートインデックス", "asset_class": "REIT", "default_ret": 0.05, "default_vol": 0.18},
    {"asset_code": "EMAXIS-8BAL", "proxy_ticker": "AOA", "name": "eMAXIS Slim バランス(8資産均等型)", "asset_class": "Bond", "default_ret": 0.04, "default_vol": 0.10},
    {"asset_code": "RAKUTEN-BAL", "proxy_ticker": "AOM", "name": "楽天・インデックス・バランス・ファンド", "asset_class": "Bond", "default_ret": 0.03, "default_vol": 0.08},
