...
class Settings(BaseSettings):
    ...
    allowed_origins: str = Field(default="http://localhost:3000,http://localhost:3001,https://investment-sim-frontend.vercel.app,https://investment-sim-frontend-git-main-stand7hotmails-projects.vercel.app", validation_alias="ALLOWED_ORIGINS")
