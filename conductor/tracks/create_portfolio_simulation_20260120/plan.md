...
- [x] **Task: Implement Portfolio Creation Form** 52d1c0c
    - [x] Write failing tests for portfolio creation form submission.
    - [x] Create a form component using React Hook Form and Zod for validation.
